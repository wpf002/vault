...
export const MODULE_REGISTRY: Record<string, () => Promise<{ default: ModuleManifest }>> = {
  'ai-mental-health-companion': () => import('@vault/mod-ai-mental-health-companion'),
  'mental-health-journal': () => import('@vault/mod-mental-health-journal'),
  'diet-planning-assistant': () => import('@vault/mod-diet-planning-assistant'),
  'recipe-planner-pantry': () => import('@vault/mod-recipe-planner-pantry'),
  'social-media-curator': () => import('@vault/mod-social-media-curator'),
  'multilingual-travel-companion': () => import('@vault/mod-multilingual-travel-companion'),
  'browser-cookie-manager': () => import('@vault/mod-browser-cookie-manager'),
  'smart-interior-planner': () => import('@vault/mod-smart-interior-planner'),
  'ecommerce-ai-agent': () => import('@vault/mod-ecommerce-ai-agent'),
  'hrms-chatbot': () => import('@vault/mod-hrms-chatbot'),
  'itinerary-generator': () => import('@vault/mod-itinerary-generator'),
  'home-maintenance-predictor': () => import('@vault/mod-home-maintenance-predictor'),
  'feedback-analyzer': () => import('@vault/mod-feedback-analyzer'),
  'ai-shopping-recommendation': () => import('@vault/mod-ai-shopping-recommendation'),
  'ai-learning-companion': () => import('@vault/mod-ai-learning-companion'),
  'financial-dashboard': () => import('@vault/mod-financial-dashboard'),
  'fitness-tracking-platform': () => import('@vault/mod-fitness-tracking-platform'),
  'ai-health-coach': () => import('@vault/mod-ai-health-coach'),
  'podcast-audio-curator': () => import('@vault/mod-podcast-audio-curator'),
  'meeting-follow-up-automator': () => import('@vault/mod-meeting-follow-up-automator'),
  'smart-content-generator': () => import('@vault/mod-smart-content-generator'),
  'fuel-delivery': () => import('@vault/mod-fuel-delivery'),
  'dice-roller-coin-flipper': () => import('@vault/mod-dice-roller-coin-flipper'),
  'social-food-delivery': () => import('@vault/mod-social-food-delivery'),
  ...
  'niche-crm': () => import('@vault/mod-niche-crm'),
  ...
  'collaborative-whiteboard': () => import('@vault/mod-collaborative-whiteboard'),
  'data-visualization-dashboard': () => import('@vault/mod-data-visualization-dashboard'),
  'random-idea-generator': () => import('@vault/mod-random-idea-generator'),
  'disaster-management': () => import('@vault/mod-disaster-management'),
  'complaint-registering': () => import('@vault/mod-complaint-registering'),
  ...
  'local-event-aggregator': () => import('@vault/mod-local-event-aggregator'),
  'educational-minigame-arcade': () => import('@vault/mod-educational-minigame-arcade'),
  'study-group-organizer': () => import('@vault/mod-study-group-organizer'),
  'language-learning-game': () => import('@vault/mod-language-learning-game'),
  'online-course-platform': () => import('@vault/mod-online-course-platform'),
  'skills-assessment-builder': () => import('@vault/mod-skills-assessment-builder'),
  'language-exchange-matching': () => import('@vault/mod-language-exchange-matching'),
  ...
  'e-wallet': () => import('@vault/mod-e-wallet'),
  'wealth-asset-management': () => import('@vault/mod-wealth-asset-management'),
  'fractional-asset-ownership': () => import('@vault/mod-fractional-asset-ownership'),
  'sustainable-finance-tracker': () => import('@vault/mod-sustainable-finance-tracker'),
  'micro-investing': () => import('@vault/mod-micro-investing'),
  'gamified-budgeting': () => import('@vault/mod-gamified-budgeting'),
  'tax-estimate-calculator': () => import('@vault/mod-tax-estimate-calculator'),
